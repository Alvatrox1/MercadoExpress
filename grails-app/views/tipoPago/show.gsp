...
<html>
    ...
    <body>
        ...
        <div id="show-tipoPago" class="content scaffold-show" role="main">
            ...
            <f:display bean="tipoPago" />
            <g:form resource="${this.tipoPago}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.tipoPago}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
